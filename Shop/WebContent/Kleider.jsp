...
<div class="header-bot">
	<div class="header-bot_inner_wthreeinfo_header_mid">
		<div class="col-md-4 header-middle">
			<form action="SearchServ2" method="post">
...
<div class="gallery">
  ...
  <div class="desc"><%out.println(list.get(i).getName() +" CHF"+ list.get(i).getPrice() +".- " );%></div>
  <div class="col-sm-6 newsright">
    <form action="ShoppingBag.jsp" method="post">
  <div class="desc"><%out.print(list.get(i).getName() +" CHF"+ list.get(i).getPrice() +".- " +list.get(i).getBrand());%></div>
