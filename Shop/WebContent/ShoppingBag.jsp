...
<%
	ArrayList<String> list = (ArrayList<String>)session.getAttribute("listtext");
	ArrayList<String> listbild = (ArrayList<String>)session.getAttribute("listbild");
	if(list == null){
		
		list = new ArrayList<String>();
		session.setAttribute("listtext", list);
	}
	if(listbild == null){
		listbild = new ArrayList<String>();
		session.setAttribute("listbild", listbild);
...
for(int i = 0; i < list.size(); i++){
	if(listbild.get(i) != null){
%>
	<% out.println("\n");%>
<div class="gallery">
  <a target="_blank" href="img_5terre.jpg">
    <img src=<%=listbild.get(i)%> alt=<%=listbild.get(i)%> width="600" height="400">
  </a>
  <div class="desc"><%out.println(list.get(i));%></div>
</div>
<%}} %>
...
<div class="footer">
	...
	<div class="footer_agile_inner_info_w3l">
		...
		<div class="bestellendiv">
<div class="col-sm-6 newsright">
<form action="Bestelleung.jsp" method="post">
